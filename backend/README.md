...
## Project Structure
    ...
    ├── ideaprocs_llc_myebo_36404  # Django project configurations
...
1. Clone this repo and `cd ideaprocs_llc_myebo_36404`
...
2. Clone this repo and `cd ideaprocs_llc_myebo_36404`
